...
# It's simple command line game:
# The game goes like this:

# 1. The computer will think of 5 digit numbers that has no repeating digits.
# 2. You will then guess a 5 digit number
...
#GENERATE COMPUTER CODE 12345
def generate_code():
    '''
    generates a 5 digit list for the code
    '''
    digits = [str(num) for num in range(10)]
    #Shuffle the digits
    random.shuffle(digits)
    # Then grab the first five
    return digits[:5]
# GENERATE THE CLUES
...
# Run Game
print("Welcome Code Breaker! Let's see if you can guess my 5 digit number!")

# Create a Secret Code to start the Game
secretCode = generate_code()
print("Code has been generated, please guess a 5 digit number")
#print(secretCode)
